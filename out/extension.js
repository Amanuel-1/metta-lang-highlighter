...
function activate(context) {
            ...
            for (let i = 0; i < lines.length; i++) {
                ...
                if (line.includes('register-module!') || line.includes('import!')) {
                    ...
                    if (match) {
                        ...
                        symbols.push(new vscode.SymbolInformation(modulePath, vscode.SymbolKind.Module, new vscode.Range(i, 0, i, line.length)));
                    }
                }
            }
            return symbols;
    ...
    function updateImportDecorations(editor) {
        if (!editor)
            return;
